/** Output standard uibuilder UI config to create a uPlot chart in your front-end web app
 * Send output to a uibuilder node.
 *
...
const mod = {
    ...
    nodeName: 'uib-uplot', // Note that 'uib-uplot' will be replaced with actual node-name. Do not forget to also add to package.json
}
